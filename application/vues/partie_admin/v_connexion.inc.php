...
<div class="containerCo">
    <h5>Administration du site (Accès réservé) </h5>
    ...
    <form method="post" action="index.php?controleur=Admin&action=verifierConnexion&display=minimal">
        <div class="form-group">
            <label>Login</label>
            <input type="text" name="login" id="login" placeholder="Entrer votre login" required>
        </div>
